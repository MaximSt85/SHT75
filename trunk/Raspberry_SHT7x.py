...
__all__ = ["Raspberry_SHT7x", "Raspberry_SHT7xClass", "main"]
...
#----- PROTECTED REGION ID(Raspberry_SHT7x.additionnal_import) ENABLED START -----#
...
class SHT1x:
    ...
    def __init__(self, data_pin, sck_pin, gpio_mode=GPIO.BOARD, vdd='5V', resolution='High',
...
#----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.additionnal_import
...
class Raspberry_SHT7x (PyTango.Device_4Impl):
    """Class to measure humidity with raspberry and SHT7x sensors"""
    
    # -------- Add you global variables here --------------------------
    #----- PROTECTED REGION ID(Raspberry_SHT7x.global_variables) ENABLED START -----#
    
    #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.global_variables

    def __init__(self, cl, name):
        PyTango.Device_4Impl.__init__(self,cl,name)
        self.debug_stream("In __init__()")
        Raspberry_SHT7x.init_device(self)
        #----- PROTECTED REGION ID(Raspberry_SHT7x.__init__) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.__init__
        
    def delete_device(self):
        self.debug_stream("In delete_device()")
        #----- PROTECTED REGION ID(Raspberry_SHT7x.delete_device) ENABLED START -----#
        self.sensor = None
        self.set_state(PyTango.DevState.OFF)
        self.set_status("Device is in OFF state")
        #GPIO.cleanup()
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.delete_device
    ...
    def init_device(self):
        ...
        #----- PROTECTED REGION ID(Raspberry_SHT7x.init_device) ENABLED START -----#
        self.sensor = None
        self.running = False
        self.set_state(PyTango.DevState.OFF)
        self.set_status("Device is in OFF state")
        self.On()
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.init_device

    def always_executed_hook(self):
        self.debug_stream("In always_excuted_hook()")
        #----- PROTECTED REGION ID(Raspberry_SHT7x.always_executed_hook) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.always_executed_hook

    # -------------------------------------------------------------------------
    #    Raspberry_SHT7x read/write attribute methods
    # -------------------------------------------------------------------------
    
    def read_Humidity(self, attr):
        self.debug_stream("In read_Humidity()")
        #----- PROTECTED REGION ID(Raspberry_SHT7x.Humidity_read) ENABLED START -----#
        attr.set_value(self.attr_Humidity_read)
        
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.Humidity_read
    ...
    def is_Humidity_allowed(self, attr):
        ...
        #----- PROTECTED REGION ID(Raspberry_SHT7x.is_Humidity_allowed) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.is_Humidity_allowed
        return state_ok
        
    def read_Temperature(self, attr):
        self.debug_stream("In read_Temperature()")
        #----- PROTECTED REGION ID(Raspberry_SHT7x.Temperature_read) ENABLED START -----#
        attr.set_value(self.attr_Temperature_read)
        
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.Temperature_read
    ...
    def is_Temperature_allowed(self, attr):
        ...
        if attr==PyTango.AttReqType.READ_REQ:
            ...
            state_ok = not(self.get_state() in [])
        #----- PROTECTED REGION ID(Raspberry_SHT7x.is_Temperature_allowed) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.is_Temperature_allowed
        return state_ok
    ...
    def read_attr_hardware(self, data):
        ...
        #----- PROTECTED REGION ID(Raspberry_SHT7x.read_attr_hardware) ENABLED START -----#
        #time.sleep(0.5)
        #temp = self.sensor.read_temperature()
        #humidity = self.sensor.read_humidity(temp)
        #self.attr_Humidity_read = humidity
        #self.attr_Temperature_read = temp
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.read_attr_hardware


    # -------------------------------------------------------------------------
    #    Raspberry_SHT7x command methods
    # -------------------------------------------------------------------------
    ...
    def On(self):
        ...
        #----- PROTECTED REGION ID(Raspberry_SHT7x.On) ENABLED START -----#
        self.set_state(PyTango.DevState.ON)
        self.set_status("Device is in On state")
        #GPIO.setmode(GPIO.BOARD)
        self.sensor = SHT1x(self.DATA, self.SCK, gpio_mode=GPIO.BOARD)
        self.running = True
        thread = threading.Thread(target = self.getData)
        thread.start()

        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.On
        
    def is_On_allowed(self):
        self.debug_stream("In is_On_allowed()")
        state_ok = not(self.get_state() in [PyTango.DevState.ON,
            PyTango.DevState.DISABLE])
        #----- PROTECTED REGION ID(Raspberry_SHT7x.is_On_allowed) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.is_On_allowed
        return state_ok
    ...
    def Stop(self):
        ...
        #----- PROTECTED REGION ID(Raspberry_SHT7x.Stop) ENABLED START -----#
        self.running = False
        #time.sleep(1)
        self.set_state(PyTango.DevState.OFF)
        self.set_status("Device is in OFF state")
        self.sensor = None
        #GPIO.cleanup()
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.Stop
        
    def is_Stop_allowed(self):
        self.debug_stream("In is_Stop_allowed()")
        state_ok = not(self.get_state() in [PyTango.DevState.OFF])
        #----- PROTECTED REGION ID(Raspberry_SHT7x.is_Stop_allowed) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.is_Stop_allowed
        return state_ok
        

    #----- PROTECTED REGION ID(Raspberry_SHT7x.programmer_methods) ENABLED START -----#
    def getData(self):
        while self.running:
            try:
                ...
                self.attr_Humidity_read = humidity
                self.attr_Temperature_read = temp
                #self.sensor.calculate_dew_point(temp, humidity)
            except:
                #raise SHT1xError("Connection failed")
    ...
    #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.programmer_methods

class Raspberry_SHT7xClass(PyTango.DeviceClass):
    # -------- Add you global class variables here --------------------------
    #----- PROTECTED REGION ID(Raspberry_SHT7x.global_class_variables) ENABLED START -----#
    
    #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.global_class_variables
...
def main():
    try:
        ...
        py.add_class(Raspberry_SHT7xClass, Raspberry_SHT7x, 'Raspberry_SHT7x')
        #----- PROTECTED REGION ID(Raspberry_SHT7x.add_classes) ENABLED START -----#
        
        #----- PROTECTED REGION END -----#	//	Raspberry_SHT7x.add_classes
